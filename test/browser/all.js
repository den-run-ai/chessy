...
const suites = ['replay.test.js', 'a11y.test.js', 'setup.test.js', 'clocks.test.js', 'sw-update.test.js', 'migration.test.js', 'archive.test.js', 'incomplete-game.test.js', 'provenance.test.js', 'wasm-engine.test.js', 'import.test.js', 'import-ui.test.js', 'data-controls.test.js', 'delete-all.test.js', 'review.test.js', 'reflection.test.js', 'analysis-service.test.js', 'analysis-cache.test.js', 'storage-health.test.js', 'moment-scan.test.js', 'moment-review.test.js', 'train.test.js', 'progress.test.js'];
let failed = 0;
