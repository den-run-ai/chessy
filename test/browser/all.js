...
const suites = ['replay.test.js', 'a11y.test.js', 'setup.test.js', 'clocks.test.js', 'sw-update.test.js', 'migration.test.js', 'archive.test.js', 'review.test.js', 'reflection.test.js', 'train.test.js', 'progress.test.js'];
let failed = 0;
