...
This is frozen development/test data, not a shipped engine asset and not an
implemented release gate. Issue #156 still requires reviewed runner,
aggregation, trusted provenance and workflow integration before measurement.
Do not use these openings to choose weights, features or networks.
...
v1 evidence. The protocol constants are prospective only: no new formal match
should run until #156's complete trust and integration tests pass.
